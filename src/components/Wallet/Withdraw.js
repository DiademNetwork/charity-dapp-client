  ...
  render () {
    ...
    return [
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Please provide a withdrawal address and an amount (max {balance} DCT minus fees of around 0.01 DCT) to withdraw tokens from your Diadem network hot wallet
          </DialogContentText>
          <TextField
            ...
            fullWidth
            helperText='Fees are around 0.1 DCT'
          />
          <TextField
